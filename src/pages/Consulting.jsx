...
const Consulting = () => {
  ...
  const navigateLightbox = (dir) => {
    const currentIndex = conImages.findIndex(i => i.id === lightbox.id)
    const next = (currentIndex + dir + conImages.length) % conImages.length
    setLightbox(conImages[next])
  }
    ...
    <div className="con-page">
      ...
      <header className="con-hero">
        <div className="con-hero-inner">
          <p className="con-hero-tag">Consulting</p>
          <h1 className="con-hero-title">Design Work</h1>
        </div>
        <div className="con-hero-bar" />
      </header>
      ...
      {/* Lightbox */}
      {lightbox && (
        <div className="con-lightbox" onClick={closeLightbox}>
          <div className="con-lightbox-inner" onClick={e => e.stopPropagation()}>
